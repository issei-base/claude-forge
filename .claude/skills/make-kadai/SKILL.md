...
- **AWS の手順は記憶で書かない**。コマンド・サービス名・上限・前提は [[aws-docs]] skill で一次ソースに当ててから課題に落とす。
...
- **AWS の正確さ**: サービス名・操作手順・前提（リスナー/ターゲットグループ/ヘルスチェック等）は [[aws-docs]] で裏取りしてから書く。無料枠・課金の注意とクリーンアップ手順は必ず入れる（受講生の事故防止）。
