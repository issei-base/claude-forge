...
- [ ] Phase 8.5: Codex 応答ループ（§4 参照・最大2サイクル）
...
`no checks reported` / 空出力ならこの CI Phase をスキップして Phase 8.5（Codex 応答ループ）へ。
...
- 停止: 新規 critical/blocking が 0 / **最大 2 サイクル**（CI の 3 より少なく）/ 残りが要人間判断のみ。残った要人間判断は要約して Phase 10 でユーザーに引き継ぐ。
