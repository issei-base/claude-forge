...
allowed-tools: Read, Write, Edit, Glob, Grep, Skill, Agent, Bash(git:*), Bash(gh pr view:*), Bash(gh pr edit:*), Bash(gh pr comment:*), Bash(gh pr checks:*), Bash(gh repo clone:*), Bash(gh run list:*), Bash(gh run view:*), Bash(gh issue view:*), Bash(gh issue comment:*), Bash(gh api:*), Bash(sleep:*), Bash(timeout:*), Bash(ls:*), Bash(awk:*), Bash(tr:*), Bash(terraform fmt:*), Bash(terraform validate:*), Bash(terraform plan:*), Bash(prettier:*), Bash(npx prettier:*), Bash(eslint:*), Bash(npx eslint:*), Bash(ruff:*), Bash(golangci-lint:*)
---
